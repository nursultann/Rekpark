    ...
    product.media?.length > 0 ?
        <>
            {product.media.map((item) =>
                items.push(
                    <div style={{ backgroundImage: "url(" + item.original_url + ")", height: 170, width: "100%", backgroundSize: "cover", borderRadius : "10px" }} />)
            )}
        </>
        :
        <>
                ...
                <div class="card-body px-2 px-md-3">
                    ...
                    <div className="row">
                        ...
                        <div className="col-9 mt-5 px-0 text-right" style={{ fontSize: 11, color: "rgb(9, 72, 130)" }}>
                            <i class="fa-solid fa-calendar-days text-danger"></i> {update}<br />
