...
const ProductItem = ({ product }) => {
    ...
    product.media?.length > 0 ?
        ...
        <>
            ...
            /></>
    return (
        <div className="col-md-12 border shadow-sm" style={{ ...baseStyle }}>
            <div className="row">
            ...
            <a onClick={() => navigateToProductDetailsPage(product)}>
                <div class="card-body px-2 px-md-3">
                    <div className="row">
                        <label style={{ fontSize: 16 }} class="card-title px-0 col-md-12 py-0">{product.price + " " + product.currency_symbol}</label>
                        <label style={{
                    ...
                    <div className="row">
                        ...
                        <div className="col-9 mt-5 px-0 text-right" style={{ fontSize: 11, color: "rgb(9, 72, 130)" }}>
                            <i class="fa-solid fa-calendar-days"></i> {update}<br />
