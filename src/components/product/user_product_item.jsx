                ...
                <div className="row">
                    ...
                    <div className="col-6 py-2">
                        {product.status == "active" ?
                            <div className="col-12 d-none d-lg-block p-1 mb-2 bg-success rounded text-center text-white">
                                Активен
                            </div>
                            : <></>
                        }
                        {product.status == "inactive" ?
                            <div className="col-12 d-none d-lg-block p-1 mb-2 bg-danger rounded text-center text-white">
                                Неактивен
                            </div>
                            : <></>
                        }
                        {product.status == "moderation" ?
                            <div className="col-12 d-none d-lg-block p-1 mb-2 bg-warning rounded text-center text-white">
                                На модерации
                            </div>
                            : <></>
                        }
                        {product.status == "disabled" ?
                            <div className="col-12 d-none d-lg-block p-1 mb-2 bg-secondary rounded text-center text-white">
                                Отключен
                            </div>
                            : <></>
                        }
                                                        ...
                                                        <div className="col-12 px-0">
                                                            <div className="row">
                                                                ...
                                                                <div className="col-9 pl-0">
                                                                    <a className="text-dark" onClick={() => makeSubscriptionModal(product.id, item.name)}>{item.title}</a>
                                                                </div>
