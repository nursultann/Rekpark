...
const ProductItem = ({ product, onClick, border = true }) => {
    ...
    if (product.is_vip) {
        ...
        baseStyle.boxShadow = "1px 1px 20px red";
    } else if (product.is_urgent) {
        baseStyle.border = "4px solid yellow";
    } else {
        baseStyle.border = "";
    }
    ...
    return (
        ...
        >
            {product.is_vip ?
                <span class="position-absolute badge badge-danger vip">Vip</span> 
                :
                <></>
            }
            {product.is_urgent ?
                <span class="position-absolute badge badge-warning urgent">Срочно</span> 
                :
                <></>
            }
